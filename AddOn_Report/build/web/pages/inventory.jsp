...
<section class="container">
    <div class="wrap-login100" style="width: 100%;margin-bottom: 0px;">
        ...
        <!--        <label for="txtWhs">Whs. :</label>
                <input id="vtxtWhs" style="width: 50px" name="txtWhs" type="text"/>
                <label for="txtFunc">Order Type :</label>
                <input id="vtxtFunc" style="width: 50px" name="txtFunc" value="A27" type="text"/>-->
        ...
        <select class="form-control" select id="vVoucherNumber"  style="width: 250px"></select>
...
//                {type: "control", width: 50, modeSwitchButton: false, editButton: false},
                {title: "Alloc. Code", name: "E2CODE", type: "select", editing: false, align: "center", items: facility, valueField: "A1CODE", textField: "ALLOCATION", width: 100},
...
//                {title: "ACCC", name: "ACCC", type: "text", align: "left", validate: "required", width: 70},
                ...
                {title: "DESC", name: "DESC", css: "limitext", type: "text", align: "left", validate: "required", width: 100},
                {title: "REF1", name: "REF1", css: "limitext", type: "text", align: "center", validate: "required", width: 60},
                {title: "REF2", name: "REF2", css: "limitext", type: "number", align: "center", validate: {validator: "range", param: [1, 99]}, width: 60},
                {title: "REF3", name: "REF3", css: "limitext", type: "text", align: "left", validate: "required", width: 60},
//                {title: "VOUC", name: "VOUC", css: "limitext", type: "text", align: "left", validate: "required", width: 150},
                {title: "QTY", name: "QTY", type: "decimal", align: "right", validate: "required", css: "lvgb", width: 100, itemTemplate: function (value) {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, xhr) {
                    $.each(data, function (i, obj) {
                        var div_data = "<option>" + obj.txtResult + "</option>";
//                    console.log(div_data);
                        $(div_data).appendTo('#vVoucherNumber');
                    });
