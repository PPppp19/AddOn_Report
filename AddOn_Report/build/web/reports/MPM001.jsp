...
<div class="container">
    <div class="wrap-login100" >
        ...
        <form id="detailsForm" class="login100-form validate-form" target="_blank" action="Report" method="GET">
            ...
            <div class="details-form-field">
                <label>MO :</label>
                <input class="form-control form-control-user" id="vMO" name="mono" type="number" placeholder="Input MO" />
            </div>
        ...
        <form align="center">
            <hr class="my-4">
            <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="MPM001" type="submit">PDF</button>
            <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="MPM001_Excel"type="submit">Excel</button>
        </form> 
