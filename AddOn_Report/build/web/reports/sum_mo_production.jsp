...
<div class="container">
    <div class="wrap-login100" >
        ...
        <form id="detailsForm" class="login100-form validate-form" target="_blank" action="Report" method="GET">
            ...
            <h3>Summary MO Production Report</h3>
            <br>
        ...
        <form align="center">
            ...
            <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="Sum_MO_Report_Excel"type="submit">Excel</button>
        </form> 
