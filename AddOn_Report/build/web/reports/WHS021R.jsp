    ...
    <div class="container">
        <div class="wrap-login100" >
            ...
            <form id="detailsForm" class="login100-form validate-form" target="_blank" action="Report" method="GET">
                ...
                <div class="details-form-field">
                    <label>Lot. No.:</label>
                    <input class="form-control form-control-user" id="lot" name="lot" type="text" placeholder="Input Lot. NO." />
                </div>
            </form>

            <form align="center">
                <hr class="my-4">
                <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="WHS021R" type="submit">PDF</button>
                <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="WHS021R_Excel"type="submit">Excel</button>
            </form> 
