        ...
        <form id="detailsForm" class="login100-form validate-form" target="_blank" action="Report" method="GET">
            ...
            <div class="details-form-field">
                <label>To Date(yyyymmdd) :</label>
                 <input type="date" id="vTodate" name="tdate" class="form-control">
            </div>
             <div class="details-form-field">
...
<!--            <div class="details-form-field">
        ...
        <form align="center">
            <hr class="my-4">
            <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="MPM012" type="submit">PDF</button>
            <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="MPM012_Excel"type="submit">Excel</button>
        </form> 
