...
<div class="container">
    <div class="wrap-login100" >
        ...
        <form align="center">
            ...
            <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="MO_Report_Excel"type="submit">Excel</button>
        </form> 
