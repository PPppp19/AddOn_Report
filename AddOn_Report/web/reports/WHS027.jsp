...
<html>
    <div class="container">
        <div class="wrap-login100" >
            ...
            <form align="center">
                <hr class="my-4">
                <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="WHS027" type="submit">PDF</button>
                <button class="btn btn-primary mb-2" style="color:#FFFFFF;" form="detailsForm" name="report" value="WHS027_Excel"type="submit">Excel</button>
            </form> 
