...
<section class="container">
    ...
    <div id="detailsDialog">
        <form id="detailsForm">
            ...
            <!--            <div class="details-form-field">
                        ...
                        <div class="details-form-field">
                            ...
                            <input id="vUnitQty" name="E1EPAT" type="number" value="0"/>
                        </div>
                        <div class="details-form-field">
                            <label for="E1EPQT">Amount :</label>
                            <input id="vAmount" name="E1EPQT" type="number" value="0" onkeyup="CalVat()"/>
                        </div>
                        <div class="details-form-field">
                            <label for="E1EVAT">Vat 7% :</label>
                            <input id="vVat" name="E1EVAT" type="number" value="0" disabled="true"/>
                        </div>
                        <div class="details-form-field">
                            <label for="E1ETAT">Total :</label>
                            <input id="vTotal" name="E1ETAT" type="number" value="0" disabled="true"/>
                        </div>-->
            <div class="details-form-field">
                <label for="E1RAAT">Total Amt. :</label>
                <input id="vTotalAmt" name="E1RAAT" type="number" />
            </div>
            <input id="vMeterStart" name="E1METS" type="hidden" value="0"/>
            <input id="vMeterEnd" name="E1METE" type="hidden" value="0"/>
            <input id="vUnitQty" name="E1EPAT" type="hidden" value="0"/>
            <input id="vAmount" name="E1EPQT" type="hidden" value="0"/>
            <input id="vVat" name="E1EVAT" type="hidden" value="0"/>
            <input id="vTotal" name="E1ETAT" type="hidden" value="0"/>
        </form><br>
        <div id="detailsForm2" align="center">
            ...
            <!--<button class="btn btn-danger" type="submit" form="detailsForm" id="vDelete">Delete</button>--> 
        </div>
    </div>
</section>
...
//            autoload: true,
            ...
            controller: {
                ...
                insertItem: function (item) {
                    ...
                    item.A3CONO = item.E1CONO;
                    item.A3DIVI = item.E1DIVI;
                    item.E2CODE = item.E1CODE;
                    item.E2PECO = item.E1PECO;
                    item.E2TYPE = item.E1TYPE;
                    item.page = "InsertAllocationVariance";
                    $.ajax({
                        url: './Sync',
                        type: 'POST',
                        dataType: 'json',
...
//                $("#jsGrid").jsGrid("loadData");
                ...
                deleteItem: function (item) {
                    ...
                    var cono = <%out.print(session.getAttribute("cono"));%>
                    var divi = <%out.print(session.getAttribute("divi"));%>
                    var code = item.E1CODE;
                    var period = item.E1PECO;
...
//                    editButton: false,
    ...
    function CalVat() {
        ...
        var totalamt = parseFloat(amt) + (parseFloat(vat) * (81.67 / 100));
    ...
    $("#vAllocated").click(function () {
        ...
        if (r === true) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    page: "InsertBillsAllocatedVariance",
                    cono: cono,
                    divi: divi,
                    code: code,
                    period: period,
